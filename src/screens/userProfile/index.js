...
const userProfile = () => {
    ...
    <Container sx={{
        ...
        <Box sx={{
            ...
            <Item><img className='image-size' src='https://www.realsimple.com/thmb/QHkrGeiLf4vEV5342LyWEmv5cvI=/1500x0/filters:no_upscale():max_bytes(150000):strip_icc()/Real-Simple-work-clothes-for-women-affordable-v1-951a9c4310ee4db59e64f2f66b0fdcfe.jpg' /></Item>
           </Grid>
  ))}
</Grid>
        </Box>
